...
public class Adminuserlocationcoast extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_adminuserlocationcoast);
        ...
        call1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (phoneNumber != null && !phoneNumber.isEmpty()) {
                    ...
                    Toast.makeText(Adminuserlocationcoast.this, "Waiting for Admin's Response to get their Contact Number", Toast.LENGTH_SHORT).show();
                }
        ...
        if (!isFinishing() && !isDestroyed()) {
            ...
            builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    Intent intent = new Intent(Adminuserlocationcoast.this, DashboardUser.class);
    ...
    private void showDistanceDialog(double distance) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(Adminuserlocationcoast.this);
    ...
    private void callContactNumber(String phoneNumber) {
        ...
        if (phoneNumber != null && !phoneNumber.isEmpty()) {
            ...
            if (callIntent.resolveActivity(getPackageManager()) != null) {
                ...
                Toast.makeText(Adminuserlocationcoast.this, "No app available to make calls", Toast.LENGTH_SHORT).show();
            }
        } else {
            // Phone number is empty
            Toast.makeText(Adminuserlocationcoast.this, "Contact number not available", Toast.LENGTH_SHORT).show();
        }
    }
