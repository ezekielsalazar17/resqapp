...
public class MyAdaptercoast extends RecyclerView.Adapter<MyViewHoldercoast> {

    private final Context context;
    private final List<Itemcoast> items;
    ...
    public MyAdaptercoast(Context context, List<Itemcoast> items) {
    ...
    @NonNull
    @Override
    public MyViewHoldercoast onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_view, parent, false);
        return new MyViewHoldercoast(itemView);
    }
    ...
    @Override
    public void onBindViewHolder(@NonNull MyViewHoldercoast holder, int position) {
        Itemcoast currentItem = items.get(position);
    ...
    private void performOperationsSynchronously(Itemcoast currentItem) {
    ...
    private void inProgressfetching(OnCompleteListener1 listener, Itemcoast currentItem) {
    ...
    private void addToFireDeptUserCollection(OnCompleteListener listener, Itemcoast currentItem) {
        FirebaseFirestore db = FirebaseFirestore.getInstance();
    ...
    private void startLocationSharingAdminActivity(Itemcoast currentItem, String address, String latitude, String longitude) {
        Intent intent = new Intent(context, LocationSharingAdminCoast.class);
