...
public class MyAdapterpolice extends RecyclerView.Adapter<MyViewHolderpolice> {

    private final Context context;
    private final List<Itempolice> items;
    ...
    public MyAdapterpolice(Context context, List<Itempolice> items) {
    ...
    @NonNull
    @Override
    public MyViewHolderpolice onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_view, parent, false);
        return new MyViewHolderpolice(itemView);
    }
    ...
    @Override
    public void onBindViewHolder(@NonNull MyViewHolderpolice holder, int position) {
        Itempolice currentItem = items.get(position);
    ...
    private void performOperationsSynchronously(Itempolice currentItem) {
    ...
    private void inProgressfetching(OnCompleteListener1 listener, Itempolice currentItem) {
    ...
    private void addToFireDeptUserCollection(OnCompleteListener listener, Itempolice currentItem) {
        FirebaseFirestore db = FirebaseFirestore.getInstance();
    ...
    private void startLocationSharingAdminActivity(Itempolice currentItem, String address, String latitude, String longitude) {
        Intent intent = new Intent(context, LocationSharingAdminPolice.class);
