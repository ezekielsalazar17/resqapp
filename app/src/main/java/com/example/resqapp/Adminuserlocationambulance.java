...
public class Adminuserlocationambulance extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_adminuserlocationambulance);
        ...
        call1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (phoneNumber != null && !phoneNumber.isEmpty()) {
                    ...
                    Toast.makeText(Adminuserlocationambulance.this, "Waiting for Admin's Response to get their Contact Number", Toast.LENGTH_SHORT).show();
                }
    ...
    private void showDistanceDialog(double distance) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(Adminuserlocationambulance.this);
    ...
    private void callContactNumber(String phoneNumber) {
        ...
        if (phoneNumber != null && !phoneNumber.isEmpty()) {
            ...
            if (callIntent.resolveActivity(getPackageManager()) != null) {
                ...
                Toast.makeText(Adminuserlocationambulance.this, "No app available to make calls", Toast.LENGTH_SHORT).show();
            }
        } else {
            // Phone number is empty
            Toast.makeText(Adminuserlocationambulance.this, "Contact number not available", Toast.LENGTH_SHORT).show();
        }
    }
