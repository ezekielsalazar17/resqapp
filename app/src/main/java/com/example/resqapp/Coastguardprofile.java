...
public class Coastguardprofile extends AppCompatActivity {
    ...
    private Button coastconedit;
    private ImageView coastpic;
    private Uri imageUri;
    private Uri savedImageUri;
    private FirebaseStorage storage;
    private StorageReference storageRef;
    FloatingActionButton coastpicedit;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        coastconedit = findViewById(R.id.edit_contact4);
        coastpic = findViewById(R.id.coastpicture);
        coastpicedit = findViewById(R.id.coast_profile_change);
        ...
        ////////////////////////////// COAST GUARD CHANGE PICTURE ///////////////////////////////

        coastpicedit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new AlertDialog.Builder(Coastguardprofile.this)
                        .setTitle("Confirm Selection")
                        .setMessage("Are you sure you want to select an image?")
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                ImagePicker.with(Coastguardprofile.this)
                                        .crop()
                                        .compress(1024)
        ...
        if (savedImageUriString != null) {
            ...
            try {
                ...
                coastpic.setImageBitmap(circularBitmap);
            } catch (IOException e) {
                e.printStackTrace();
            }
        ...
        ////////////////////////////// COAST GUARD CHANGE NUMBER ///////////////////////////////
        coastconedit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Open a dialog or start a new activity to edit the contact number
                // For example, you can use an AlertDialog to get user input
                AlertDialog.Builder builder = new AlertDialog.Builder(Coastguardprofile.this);
                builder.setTitle("Edit Contact Number");

                final EditText input = new EditText(Coastguardprofile.this);
    ...
    private void saveImageUriToPreferences(Uri uri) {
        ...
        SharedPreferences.Editor editor = preferences.edit();
        if (uri != null) {
            editor.putString("image_uri_coast", uri.toString());
        } else {
            editor.remove("image_uri_coast");
        }
        editor.apply();
    }
    ...
    private void uploadImageToStorage(Uri imageUri) {
        if (imageUri != null) {
            StorageReference imageRef = storageRef.child("profileImages_coast").child(userID + ".jpg");

            imageRef.putFile(imageUri)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        @Override
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            Toast.makeText(Coastguardprofile.this, "Image uploaded successfully", Toast.LENGTH_SHORT).show();
                        }
                    })
                    .addOnFailureListener(new OnFailureListener() {
                        @Override
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(Coastguardprofile.this, "Failed to upload image", Toast.LENGTH_SHORT).show();
                        }
                    });
        }
    }
